...
多账号换行
点击 https://h5.sxsjyzm.com/sesameH5/public/sesameLogin/register.html?onlyid=613454382 下载APP
或者商店搜索 芝嫲视频 邀请码613454382
谢谢支持
...
############## 圈x
#芝嫲视频获取body
https:\/\/api\.sxsjyzm\.com\/* url script-request-body  
############## loon
#芝嫲视频获取body
http-request https:\/\/api\.sxsjyzm\.com\/* script-path=
############## surge
#芝嫲视频获取body
芝嫲视频获取body = type=http-request,pattern=https:\/\/api\.sxsjyzm\.com\/*,requires-body=1,max-size=0,script-path=
